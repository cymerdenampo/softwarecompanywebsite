                        ...
                        <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
                            <ul class="navbar-nav  ">
                                <li class="nav-item active">
                                    <a class="nav-link" href="{{ asset('cymer/index.html') }}">Home <span
                                            class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('cymer/about.html') }}"> About </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('cymer/do.html') }}"> What we do </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('cymer/portfolio.html') }}"> Portfolio </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('cymer/contact.html') }}">Contact us</a>
                                </li>
                            </ul>
